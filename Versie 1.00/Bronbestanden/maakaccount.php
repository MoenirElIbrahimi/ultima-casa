...
<head>
    ...
    <style>
        .form-check-label::before {
            border-color: #000; /* Set the line color to black */
        }
    </style>
</head>
                        ...
                        <form action="maakaccount-save.php" method="POST">
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="acceptTerms"><a href="avg_voorwaarden.html">Ik ga akkoord met de AVG-voorwaarden</a></label>
                                    <hr style="margin: 5px 0; border-color: #000;"> <!-- Set the line color to black -->
                                </div>
                            </div>

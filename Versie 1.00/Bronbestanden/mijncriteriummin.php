...
<div class="container">
    <div class="col-sm-5 col-md-7 col-lg-5 col-sm-offset-4 col-md-offset-3 col-lg-offset-4">
        ...
        <?php
        if ($gegevens["Type"] == 1) { // Van - T/m
            echo '<h3>' . $gegevens["Criterium"] . '</h3>
                 <div class="form-group">
                      <label for="Van">Van:</label>
                      <input type="number" class="form-control" min=0 value="' . $gegevens["Van"] . '" id="Van" name="Van" readonly>
                 </div>
                 <div class="form-group">
        ...
        <form action="mijncriteriumdel.php" method="POST">
            <div class="form-group">
                <button type="submit" class="action-button" id="del" name="del" value="<?= $ID ?>" title="Dit criterium verwijderen.">Verwijderen</button>
